...
## returned by "makeCacheMatrix" function above. If the inverse for an unchanged matrix has already been calculated the cachesolve should be retrieving the inverse from the cache.
